...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{\href{https://cv.jnapolitano.io/parts/python-development/google/index.html}{Google Drive API}}
      {Google API application that streamlines data pipeline transformation for teams using the Google Productivity Suite.}
    \resumeSubItem{\href{https://cv.jnapolitano.io/parts/reference/build-this-site/index.html}{Sphinx CV Template}}
      {Sphinx project to create a static website of one's cv with reStructuredText and MarkDown.}
  \resumeSubHeadingListEnd
