  ...
  \section{Experience}
    \resumeSubHeadingListStart
      ...
      \resumeSubheading
        ...
        \resumeItemListStart
          \resumeItem{\href{https://www.degruyter.com/document/doi/10.1515/peps-2019-0036/html}{Article Publication}}
            {Led team to publish work in the Journal of Peace Economics, Peace Science and Public Policy.}
          \resumeItem{Peer Review}
            {Prepared presentation for peer review at the Peace Science Conference at the Hague, Switzerland.}
          \resumeItem{\href{https://docs.jnapolitano.io/parts/analysis/political-analysis/terrorism-conflict/project-turkish-kurdish/analysis.html}{Inferential Statistics}}
            {Completed inferential analysis of socio-economic data with Pandas.}
          \resumeItem{\href{https://docs.jnapolitano.io/parts/data/data-integration/index.html}{Feature Extraction}
            {Standardized feature extraction and storage methodology.}
          \resumeItem{Data Integration}
            {Integrated data into mongoDB.}
          \resumeItem{\href{https://docs.jnapolitano.io/parts/analysis/political-analysis/terrorism-conflict/project-turkish-kurdish/database_schema.html}{Database Design}}
            {Defined third normal database for permanent record.}
