...
%-----------------Objective-------------------------------
\begin{center}
Open source intelligence specialist experienced in developing analytic work flows with Python, SAS, and SPSS.  Possess knowledge of creating research methodology, managing data integration, and visualizing data for peer reviewed academic papers.  Seeking employment in role requiring analytic skill set and strong research ability. 
